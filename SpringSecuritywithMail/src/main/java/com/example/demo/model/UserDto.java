...
import com.example.demo.validation.MyOwnEmail;
import com.example.demo.validation.MyOwnPhoneNumber;
import com.example.demo.validation.PasswordConfirmed;
...
public class UserDto {
	...
	@UniqueEmail
	@MyOwnEmail(message="Email is not valid")
